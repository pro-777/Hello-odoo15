...
``` bash
curl -s https://github.com/pro-777/Hello-odoo15.git/run.sh | sudo bash -s odoo-one 10015 20015
```
...
``` bash
curl -s https://github.com/pro-777/Hello-odoo15.git/run.sh | sudo bash -s odoo-two 11015 21015
```
